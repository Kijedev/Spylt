  ...
  return (
    <section className="relative min-h-screen bg-[#7A3A2A] flex items-center justify-center overflow-hidden px-6">
      ...
      <div className="relative z-10 text-center max-w-4xl">
        <h1 className="lg:text-[7vw] text-[3rem] leading-[0.95] font-extrabold uppercase text-[#F6E6D8]">
          STIR UP YOUR
          <br />
          FEARLESS PAST AND
        </h1>
      ...
      className="inline-block bg-[#E7A85A] px-6 rotate-[4deg] border-6 border-[#7A3A2A] lg:-mt-10 "
    >
      <span className="lg:text-[7vw] text-[3rem] font-extrabold uppercase text-[#7A3A2A] whitespace-nowrap">
        ...
        <h1 className="lg:text-[7vw] text-[3rem] leading-[0.95] font-extrabold uppercase text-[#F6E6D8] lg:-mt-6">
